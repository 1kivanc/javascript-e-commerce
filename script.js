...
function addCartClicked(event){
  ...
  var title = shopProducts.getElementsByClassName('card-text')[0].innerText
  var price = shopProducts.getElementsByClassName('card-price')[0].innerText
  var productImg = shopProducts.getElementsByClassName('card-image')[0].src;
  ...
  alert('ürün sepete eklendi');
    ...
    for(var i = 0; i < cartItemsNames.length; i++){
      if (cartItemsNames[i].innerText == title){
        console.log('bu ürün sepetinizde ekli!');
        return;
      }
